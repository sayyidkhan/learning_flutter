...
//    final Uint8List ralewayRegularData = io.File("fonts/Raleway/Raleway-Regular.ttf").readAsBytesSync();
//    final ralewayRegular = widgets.Font.ttf(ralewayRegularData.buffer.asByteData());
//
//    final Uint8List ralewayBoldData = io.File("fonts/Raleway/Raleway-Bold.ttf").readAsBytesSync();
//    final ralewayBold = widgets.Font.ttf(ralewayBoldData.buffer.asByteData());
